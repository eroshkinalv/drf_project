...
class UserTestCase(APITestCase):
    ...
    def test_user_retrieve(self):
        ...
        self.assertEqual(data.get("password"), self.user.password)
    ...
    def test_user_update(self):
        ...
        self.assertEqual(data.get("payment_amount"), 1500)
...
class PaymentTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.payment = Payment.objects.create(
            user=self.user, course=self.course, payment_amount=1000, payment_method="Наличные"
        )
        self.client.force_authenticate(user=self.user)
    ...
    def test_course_retrieve(self):
        ...
        self.assertEqual(data.get("user"), self.payment.user.pk)
    ...
    def test_payment_update(self):
        ...
        self.assertEqual(data.get("payment_amount"), 1999)
